  ...
  return (
    <div className="px-4 py-3 bg-[#12141a] border-t border-[#2a2d35] flex items-center gap-3">
      ...
      <div className="flex-1 relative">
        ...
        />
        <button className="absolute right-3 top-1/2 -translate-y-1/2 text-lg grayscale hover:grayscale-0 transition-all" aria-label="Choose emoji" title="Choose emoji">
          😊
        </button>
      </div>
