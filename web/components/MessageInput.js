    ...
    <div className="px-4 py-3 bg-[#12141a] border-t border-[#2a2d35] flex items-center gap-3">
      ...
      <div className="flex-1 relative">
        <textarea
          ...
          rows={1}
          className="w-full resize-none py-3 px-4 pr-12 bg-[#1e2028] border-none focus:outline-none focus:ring-1 focus:ring-brand-500 rounded-lg text-[15px] max-h-32 overflow-y-auto"
        />
        <button
