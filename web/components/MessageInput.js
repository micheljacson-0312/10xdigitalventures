    ...
    <div className="px-4 py-3 bg-[#12141a] border-t border-[#2a2d35] flex items-center gap-3">
      ...
      <div className="flex-1 relative">
        <textarea
          ...
          className="resize-none py-3 px-4 pr-12 bg-[#1e2028] border-none focus-visible:ring-1 focus-visible:ring-brand-500 text-[15px] max-h-32 w-full block overflow-hidden"
        />
        <button
