      ...
      <div className="flex flex-col flex-1 overflow-hidden relative">
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-[#2a2d35] bg-[#12141a] flex-shrink-0 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-4 text-gray-400">
            <button className="hover:text-white transition-colors" aria-label="Search in chat" title="Search in chat">🔍</button>
            <button className="hover:text-white transition-colors" aria-label="Start voice call" title="Start voice call">📞</button>
            <button className="hover:text-white transition-colors" aria-label="Start video call" title="Start video call">📹</button>
          </div>
        </div>
