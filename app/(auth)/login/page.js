    ...
    <div className="flex items-center justify-center h-screen bg-[#0f1117]">
      <div className="w-full max-w-sm p-8 bg-[#1a1d24] rounded-2xl border border-[#3a3d45]">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Sign in to 10x Chat</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          No account?{' '}
          <Link href="/register" className="text-brand-100 hover:underline">Register with invite code</Link>
        </p>
      </div>
    </div>
  )
