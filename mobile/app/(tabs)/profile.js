...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#1db791', justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  ...
  saveBtn: { backgroundColor: '#1db791', borderRadius: 10, padding: 16, alignItems: 'center', marginTop: 4 },
